    ...
    return (
        <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="border-l-4 border-l-red-500 shadow-sm">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-gray-600">Total Pengeluaran (Periode Ini)</CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Dari Transaksi Keluar</p>
                </CardContent>
            </Card>
        </div>
    );
