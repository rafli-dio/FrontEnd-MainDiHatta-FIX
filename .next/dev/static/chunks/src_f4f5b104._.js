...
"[project]/src/components/karyawan/SidebarKaryawan.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SidebarKaryawan() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SidebarKaryawan.useEffect": ()=>{
            const fetchPendingCount = {
                "SidebarKaryawan.useEffect.fetchPendingCount": async ()=>{
                    try {
                        ...
                        const count = bookings.filter({
                            "SidebarKaryawan.useEffect.fetchPendingCount": (b)=>b.status_booking_id === 2
                        }["SidebarKaryawan.useEffect.fetchPendingCount"]).length;
                        setPendingBookingsCount(count);
                    } catch (error) {
                        console.error("Gagal memuat notifikasi booking", error);
                    }
                }
            }["SidebarKaryawan.useEffect.fetchPendingCount"];
            fetchPendingCount();
            const interval = setInterval(fetchPendingCount, 30000); // Auto refresh 30s
            return ({
                "SidebarKaryawan.useEffect": ()=>clearInterval(interval)
            })["SidebarKaryawan.useEffect"];
        }
    }["SidebarKaryawan.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SidebarKaryawan.useEffect": ()=>{
            karyawanMenuItems.forEach({
                "SidebarKaryawan.useEffect": (item)=>{
                    if (item.submenu) {
                        const isChildActive = item.submenu.some({
                            "SidebarKaryawan.useEffect.isChildActive": (sub)=>pathname === sub.href || pathname.startsWith(`${sub.href}/`)
                        }["SidebarKaryawan.useEffect.isChildActive"]);
                        ...
                        if (isChildActive || isParentActive) {
                            setExpandedMenus({
                                "SidebarKaryawan.useEffect": (prev)=>prev.includes(item.title) ? prev : [
                                        ...prev,
                                        item.title
                                    ]
                            }["SidebarKaryawan.useEffect"]);
...
_s(SidebarKaryawan, "JK8WOwmrzD+zjBsKySMbOnWli/o=", false, function() {
    return [
...
_c = SidebarKaryawan;
var _c;
__turbopack_context__.k.register(_c, "SidebarKaryawan");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/karyawan/HeaderKaryawan.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HeaderKaryawan() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HeaderKaryawan.useEffect": ()=>{
            const timer = setInterval({
                "HeaderKaryawan.useEffect.timer": ()=>setTime(new Date())
            }["HeaderKaryawan.useEffect.timer"], 1000);
            return ({
                "HeaderKaryawan.useEffect": ()=>clearInterval(timer)
            })["HeaderKaryawan.useEffect"];
        }
    }["HeaderKaryawan.useEffect"], []);
...
_s(HeaderKaryawan, "DMOuR5Yn+GCMIhpRnSXbTz9cJ6w=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c = HeaderKaryawan;
var _c;
__turbopack_context__.k.register(_c, "HeaderKaryawan");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f4f5b104._.js.map