...
function useBookingsSync(initial = [], enabled = true) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(enabled && !initial.length);
            ...
            const fetchBookings = {
                "useBookingsSync.useEffect.fetchBookings": async ()=>{
                    ...
                    try {
                        ...
                        console.error(e);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(e?.response?.data?.message || 'Gagal memuat booking.');
                    } finally{
...
_s(useBookingsSync, "fpLFw1fHJd+yfUMzmqhBtau4kpY=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/pelanggan/home/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PelangganHomepage() {
    ...
    const { bookings, loading: bookingsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useBookingsSync$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
_s(PelangganHomepage, "H9m0gfc5/5gMeDwaDEjPp5SY798=", false, function() {
    return [
...
_c = PelangganHomepage;
var _c;
__turbopack_context__.k.register(_c, "PelangganHomepage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_1b4cc177._.js.map