...
const useAuth = ({ middleware, redirectIfAuthenticated } = {})=>{
    ...
    const login = async ({ setErrors, setStatus, ...props })=>{
        ...
        setErrors([]);
        setStatus?.(null);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/login', props).then(()=>mutate()).catch((error)=>{
    ...
    const register = async ({ setErrors, ...props })=>{
        await csrf();
        setErrors([]);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/register', props).then(()=>mutate()).catch((error)=>{
            if (error.response.status !== 422) throw error;
            setErrors(error.response.data.errors);
        });
    };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/axios.ts [app-client] (ecmascript)"); // Import axios untuk fetch data
...
function Sidebar() {
    ...
    const [pendingBookingsCount, setPendingBookingsCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Sidebar.useEffect": ()=>{
                ...
                "Sidebar.useEffect.fetchPendingCount": async ()=>{
                    try {
                        ...
                        const count = bookings.filter({
                            "Sidebar.useEffect.fetchPendingCount": (b)=>b.status_booking_id === 2
                        }["Sidebar.useEffect.fetchPendingCount"]).length;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Sidebar.useEffect": ()=>{
            baseMenuItems.forEach({
                "Sidebar.useEffect": (item)=>{
                    if (item.submenu) {
                        const isChildActive = item.submenu.some({
                            "Sidebar.useEffect.isChildActive": (sub)=>pathname.startsWith(sub.href)
                        }["Sidebar.useEffect.isChildActive"]);
                        if (isChildActive) {
                            setExpandedMenus({
                                "Sidebar.useEffect": (prev)=>prev.includes(item.title) ? prev : [
                                        ...prev,
                                        item.title
                                    ]
                            }["Sidebar.useEffect"]);
...
_s(Sidebar, "JK8WOwmrzD+zjBsKySMbOnWli/o=", false, function() {
    return [
...
"[project]/src/components/admin/Header.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotificationBell() {
    _s();
    const { items, markAllRead } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 38,
                            columnNumber: 29
                        }, this) : items.map((it)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NotificationBell, "H9oWqfULaize6AmkL6m7hfaRYoY=", false, function() {
    return [
...
_s1(Header, "tRFvy0pMevC4WsGOZ194Xi7q704=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_4132c55b._.js.map